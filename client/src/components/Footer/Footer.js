        ...
        <div className="w-main flex items-center justify-center">
          ...
          <div className="flex-1 flex items-center">
            <input
              ...
              className="p-4 pr-0 rounded-l-full w-full bg-main outline-none text-gray-100 placeholder:text-sm placeholder:text-gray-200 placeholder:italic placeholder:opacity-50"
            />
            <div className="h-[56px] w-[56px] bg-main rounded-r-full flex items-center justify-center text-white border border-gray-50">
              <MdEmail size={18} />
            </div>
          </div>
        </div>
